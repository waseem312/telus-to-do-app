  ...
  const renderCard = () => todos.map(todo => (
    ...
    >
      <div>
        ...
        <h3 className="font-bold text-lg text-gray-700">{todo.email}</h3>
        <h4 className="font-bold text-lg text-gray-700">{todo.phone}</h4>
  ...
  return (
    <>
      <div className="flex flex-wrap flex-col xxs:flex-row justify-between text-center items-center mx-auto max-w-screen-xl mb-4">
        <h1 className='font-bold text-2xl text-gray-700 '>TodoList with Redux Tool</h1>
        <Link to='/add-todo'>
